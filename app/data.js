...
Our company provides specialised private preventive health care solutions with a range of experts, multidisciplinary care and one-stop option for medical diagnostics, health intervention, pharmaceuticals, and clinical treatment. Our company also bring together a comprehensive package of innovations to support health care and wellbeing, and quality food products for supply to individuals and a range of people of all age groups within Nigeria and globally.
...
MG is growing across the Philippines, UK, USA, and more.`,
    full: `As part of its operations, MG supports a range of innovative models of health and medical care, health solutions in a virtual environment and food networks for processing, supply and distribution, especially on animal production and crop processing and supply operations in Nigeria and globally. The MG clinics will reduce the problem of access to health care, preventive and early intervention, good quality care and treatment of chronic health conditions in Nigeria and Africa in general.
...
MG has the potential of expanding its global offices in the Philippines, China, USA, United Kingdom and Australia, including the attraction of best and qualified staff from around the globe to join its workforce.`,
  },
  {
    svg: (animationKey) => (
      <svg
    ...
    full: `MG will promote business partnership with reputable companies based overseas, and raise the level of awareness and business investment in healthcare and food supply solutions, and support the building professional knowledge and skills to manage chronic health conditions, improve access to information on diagnostics, health care, food supply, global pathways to health and social well-being for people.
One of our company policies is that services and products from MG is sourced directly from the manufacturer based in the source country so as to ensure good quality economic growth and development also to ensuring that good quality health standards are produced that meet the requirements of relevant international standards as enthused and endorsed by the World Health Organisation, Food And Agricultural Organisation, other United Nations agencies are promoted for our health care services and products worldwide.
We are determined to deliver the best health care food services to our clients especially in collaboration with any reputable business partners who have similar business objectives practices. MG is also focused on engaging collaborating doing a long-term international business partnership with any companies that have capacity capability of business operations in clinical diagnostic medical laboratory equipment test kits other related health medical products`,
  },
  {
    svg: (animationKey) => (
      <svg
...
We are determined to end this scourge by providing quality and international standard healthcare clinic and preventive health management services, diagnostics, health and medical equipment, food products. We have intent to also establish in the nearest future some centrally located preventive health care centers for business; get stocks stocked with modern health and medical equipment and food products; set up specialized medical diagnostic hubs, pharmaceutical outlets and offices / warehouses where products / test kits and equipment imported from overseas are distributed into markets across Africa, Asia-Pacific and other countries for supply of distribution and other related business operations.
...
MG has a unique commitment to contribute to national and international economic growth and economic prosperity in preventive health care, food security in countries where its business is established. Revenue from its business operations will be channeled back into supporting national health care programs, preventive healthcare initiatives, public hospital primary healthcare units of non-communicable and communicable diseases with an ultimate purpose of supporting a better and healthy people across Nigeria and globally.`,
  },
];
